@extends('layouts.app')
@section('title','Laravelpower | Politique de confidentialité')
@section('content')
...
Cette politique complète les Conditions Générales d’Utilisation consultables par les utilisateurs sur le lien suivant : <a href="#">Conditions d'utilisation</a>. 
</p>
...
nom, prénom, adresse email, numéro de téléphone de l'utilisateur 
</p>
<p>
La collecte et le traitement de ces données répond à la (aux) finalité(s) suivante(s) :  
gestion des utilisateurs connectés, suivi de la qualité des services, envoi de newsletter, etc.   
</p>

<h5>Article 3.2 : Mode de collecte des données</h5>
<p>
Lorsque vous utilisez notre site, sont automatiquement collectées les données suivantes : <br> 
<strong>nom, prénom, adresse email, numéro de téléphone de l'utilisateur</strong><br>
D’autres données personnelles sont collectées lorsque vous effectuez les opérations suivantes sur la plateforme : <br> 
<strong>Le nom, le prénom, l'adresse email et le numéro de téléphone des utilisateurs inscrits sur le site et pour joindre 
ceux qui laissent des messages sur le site. L'adresse email est necessaire pour s'abonner à notre newsletter.</strong><br>
Elles sont conservées par le responsable du traitement dans des conditions raisonnables de sécurité, pour une durée de :<strong>non défini</strong>
...
<pre>
Le site <strong>laravelpower</strong> est hébergé par :  
[Dénomination sociale de l’entreprise  
Adresse du siège social 
Contact (adresse email et/ou numéro de téléphone)] 

[Dans le cas ou les données personnelles collectées par l’entreprise seraient partagées avec des tiers, insérer une clause <h5>“Article 3.4 : Transmission des données à des tiers”</h5> :  
“Les données peuvent être transmises à nos partenaires, ci-après énumérés :”] 

[Si le site est concerné par l’utilisation de cookies, préciser leur utilisation dans un <h5>Article 3.5 : Politique en matière de “cookies”</h5>] 
</pre>
...
<pre>
Les données à caractère personnelles sont collectées par le site web <strong>Laravelpower</strong>.  
Le responsable du traitement des données à caractère personnel peut être contacté de la manière suivante :  
Par téléphone, au <strong>6-97-25-19-17</strong> ;  
Par mail : <strong>tachgaetan@gmail.com</strong>.   
</pre>
...
<pre>
L’éditeur du site <strong>Laravelpower</strong> se réserve le droit de pouvoir modifier la présente Politique à tout moment afin d’assurer aux utilisateurs du site sa conformité avec le droit en vigueur.  
...
La présente politique, éditée le <strong>23/06/2023</strong>, a été mise à jour le [date de modification de la politique].
</pre>
@endsection
