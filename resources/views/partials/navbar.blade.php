  ...
  <nav>
      <ul id="menu" class="bg-primary">
        ...
        <li><a href="{{ route('about_us') }}" class="text-white">Apropos</a></li>
        <li><a href="{{ route('courses') }}" class="text-white">Tutos</a></li>
        ...
        <li><a href="{{ route('upload.index') }}" class="text-white">Upload</a></li>
